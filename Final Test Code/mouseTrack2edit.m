function [OUTPUT1 OUTPUT2] = mouseTrack2edit(timeoutval, axesHandle)
...
P = createcursor('motorcycle.png');

% replace with new properties to register mouse input
set(figHandle,{'WindowButtonMotionFcn','units','Pointer','PointerShapeCData'...
    'PointerShapeHotSpot'},{@buttonMotionCallback,'pixels','custom',P,[9,9]});
